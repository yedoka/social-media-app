...
const CreatePost = () => {
  ...
  const mutation = useMutation({
    mutationFn: ({ content, imageUrl }: FormValues) => createPost(content, imageUrl),
    onSuccess: () => {
  ...
  return (
    <form
      ...
      className="flex flex-col gap-6 rounded-md border w-80 border-dark-border p-8 bg-accent-bg"
    >
